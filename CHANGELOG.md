...
- Aligned the live FaceTime handoff copy with the explicit approval phrases (`yes connect` / `yes FaceTime`), stating the required response directly, and record no-call reply-watch outcomes in SQLite when FaceTime is not opened.
