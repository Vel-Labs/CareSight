...
Use this when you want an agent to execute a complete `CareSight Hub` phase in one coordinated run.
...
- `<absolute path to docs/roadmaps/CURRENT_STATE_AND_NEXT.md>`
