...
`CareSight Hub` handles agent authority. A passing unit test is not enough if the repo still hides unclear signing behavior, unbounded execution, or unverifiable policy claims.
